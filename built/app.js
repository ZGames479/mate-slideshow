...
class HelloMyWorld {
    constructor(context) {
        ...
        setInterval(this.timerFunction, 15000, this); // add secAmount + 000 for how long till you want the image to flip
    }
    /**
    ...
    async started() {
        ...
        let cubeData = await this.assets.loadGltf(this.generateNewGLB(), "box");
        ...
        //     // currently duplicates. need to remove previous
        //     // this.context.quit(); <--- no fix
        //     this.text.destroy();
        //     this.cube.destroy();
        //     this.started();
        //     console.log("done in click");
        // });
    }
    /**
